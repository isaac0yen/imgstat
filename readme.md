...
**imgstat** is a powerful bash utility that recursively scans directories for images, downloads them, and automatically renames them to include their dimensions (e.g., `image-1920x1080.jpg`).
...
2.  **Git Bash**: Clone the repo and run `./imgstat` directly.
...
```bash
imgstat -u https://example.com/images my-folder
```